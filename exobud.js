...
showTLab();
disp1.innerHTML = "ExoBUD MP 网站媒体播放程序(雨网国际官方简体中文版)";
if(blnStatusBar){ window.status=('ExoBUD MP 网站媒体播放程序(雨网国际官方简体中文版)');}
...
disp1.innerHTML = "<font class=title>ExoBUD MP 网站媒体播放程序(雨网国际官方简体中文版)[就绪]</font>";
if(blnStatusBar){ window.status=('ExoBUD MP 网站媒体播放程序(雨网国际官方简体中文版)[就绪]');return true;}
}
...
if(f==8){capText.innerHTML="<font class=title> Exobud MP 字幕显示(SMI)</font>";}
if(f==13){
...
imgChange("playt",0);
imgChange("scope",0);
disp1.innerHTML = "<font class=title>逆风世界媒体播放程序[等待]</font>";
if(blnStatusBar){ window.status=('逆风世界媒体播放程序[等待]');return true;}
}
// evtPause() 函式: 暂停播放
function evtPause(){
imgChange("pauzt",1)
...
function waitMsg(){
capText.innerHTML="<font class=title>逆风世界字幕显示系统(SMI)</font>";
